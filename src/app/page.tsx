...
export default function Home() {
  return (
    <main className='text-gray-900'>
      <section className='mx-auto min-h-screen justify-between  bg-zinc-100 pt-40 md:pt-40 xl:p-24'>
        <div className='container mx-auto px-8 lg:flex'>
          <div className='text-center lg:w-1/2 lg:text-left xl:pt-20'>
            ...
            <p className='mt-8 md:mt-12'>
              <Link
                className='btn btn-primary mx-auto w-1/2 items-center text-white'
                href='/mytasks'
              >
                Try it Now!
              </Link>
